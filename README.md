...
This repo can also be used for local Kubernetes development. It is not advised that you run these commands in the Cloud IDE environments The purpose of these commands are to simulate the Cloud IDE environment locally on your computer. 
